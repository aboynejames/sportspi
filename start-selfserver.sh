...
# Default-Stop:         0 1 6
# Short-Description:    start selfserver
# Description:          start selfserver
### END INIT INFO
#
# Based on:
...
#
NAME=start-selfserver
NODE_BIN_DIR=/home/pi/code/node-v0.10.2-linux-arm-pi/bin
NODE_PATH=/home/pi/code/node-v0.10.2-linux-arm-pi/lib/node_modules
APPLICATION_DIRECTORY=/home/pi/nodemode/testslave/src/
APPLICATION_START=index.js
PIDFILE=/var/run/start-selfserver.pid
LOGFILE=/var/log/start-selfserver.log
...
start() {
 ...
 # someone makes an error in application initialization code, or bringing down
    ...
    # running.
    exec forever --pidFile $PIDFILE --sourceDir $APPLICATION_DIRECTORY \
